...
export default function Profile() {
  ...
  return (
    <div className="space-y-8 pb-20 text-left max-w-5xl">
      <AnimatePresence>
        {saved && (
          <motion.div
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        className="relative p-8 bg-linear-to-r from-blue-900/10 via-[#10141d] to-[#10141d] border border-white/5 rounded-[2.5rem] overflow-hidden"
      >
          ...
          >
            ...
            >
              {avatarPreview ? (
                ...
                <div className="w-full h-full bg-linear-to-br from-blue-600 to-blue-800 flex items-center justify-center text-white text-3xl font-black">
                  {initials}
                </div>
              )}
            </motion.div>
            ...
            <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-green-500 rounded-full border-2 border-[#10141d]" />
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, i) => (
          <motion.div
            ...
            className="p-5 bg-[#10141d] border border-white/5 rounded-2xl"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <motion.section
          ...
          className="lg:col-span-2 p-8 bg-[#10141d] border border-white/5 rounded-3xl space-y-6"
        >
          ...
          <div className="space-y-2">
            ...
            {isEditing ? (
              ...
              <p className="text-sm text-gray-400 leading-relaxed p-3 bg-black/40 border border-white/5 rounded-xl min-h-[80px]">
        ...
        <div className="space-y-6">
          ...
          <motion.section
            ...
            className="p-6 bg-[#10141d] border border-white/5 rounded-3xl space-y-4"
          >
          ...
          <motion.section
            ...
            className="p-6 bg-linear-to-br from-blue-900/15 to-[#10141d] border border-blue-500/15 rounded-3xl space-y-4"
          >
