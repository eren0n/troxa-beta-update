  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <AnimatePresence mode="wait">
        {activeTab === 'overview' && (
          <motion.div key="overview" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="space-y-6">
            ...
            {loading ? (
              ...
              <div className="p-6 bg-linear-to-r from-blue-600/10 via-blue-600/5 to-transparent border border-blue-500/15 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              {usageMetrics.map((m, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-5 bg-[#0b0e1a] border border-white/6 rounded-2xl space-y-4"
                  >
            ...
            <div className="bg-[#0b0e1a] border border-white/6 rounded-2xl p-6">
              ...
              <div className="flex items-end gap-1.5 h-40">
                {barData.map((h, i) => (
                  ...
                  >
                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-[#0c0f1a] border border-white/10 text-white text-[9px] font-black rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl">
                      {h * 12} gen
                    </div>
                  </motion.div>
                ))}
            ...
            {/* Cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-5 bg-[#0b0e1a] border border-white/6 rounded-2xl space-y-4">
        ...
        {activeTab === 'invoices' && (
          <motion.div key="invoices" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="bg-[#0b0e1a] border border-white/6 rounded-2xl overflow-hidden">
