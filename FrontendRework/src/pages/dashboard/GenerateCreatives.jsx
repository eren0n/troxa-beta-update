...
const models = [
  ...
  { name: 'Seedream 5.0 Pro', meta: 'Premium • $0.07/img',    badge: 'Deep Thinking', badgeColor: 'bg-orange-500/15 text-orange-400 border-orange-500/20' },
  { name: 'Ideogram v4',      meta: 'Creative • $0.015/MP',   badge: 'Text & Logos',  badgeColor: 'bg-pink-500/15 text-pink-400 border-pink-500/20' },
  { name: 'Qwen Image 2 Pro', meta: 'Detailed • $0.075/img',  badge: 'Versatile',     badgeColor: 'bg-cyan-500/15 text-cyan-400 border-cyan-500/20' },
];
...
export default function GenerateCreatives() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const [t, c, d, l, ctr, chars] = await Promise.allSettled([
          creativesApi.tags(),
