...
function ComingSoonOverlay() {
  return (
    <div className="min-h-[440px] flex items-center justify-center rounded-2xl">
      <div
        style={GLASS_STYLE}
        className="flex flex-col items-center text-center px-10 py-14 max-w-sm rounded-2xl"
      >
        ...
        <p className="text-[10px] font-black uppercase tracking-widest text-blue-400 mb-2">Coming Soon</p>
        <h2 className="text-lg font-black text-white mb-2">Billing & Plans</h2>
        <p className="text-sm text-slate-500 leading-relaxed">
          Self-serve billing is on its way. In the meantime, contact RMGS to manage your plan.
        </p>
      </div>
    </div>
  );
...
export default function BillingPanel() {
  ...
  return (
    <div className="relative space-y-6">
      <ComingSoonOverlay />
      {/*
      <p className="text-slate-500 text-sm">Manage your iGaming platform subscription and credit consumption</p>
